...
<div className="w-full flex justify-center py-12 md:py-20">
        <div className="max-w-screen-2xl w-full flex justify-left">
            <h1 className="text-4xl font-bold tracking-tight text-black sm:text-7xl">LOGOS</h1>
        </div>
    </div>
    <div className="w-full flex justify-center pb-4 md:pb-8">
        <div className="text-base md:text-xl rounded border border-[#9d9d9d] max-w-screen-2xl w-full flex-col justify-center ">
            ...
            I've worked on a huge number of logos / logos animation with Flexn 
            and React Seals, remotely or in-house.</p>
